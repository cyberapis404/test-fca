...
if (!fs.existsSync(process.cwd() + '/Sagor_Database') || !fs.existsSync(process.cwd() + '/Sagor_Database/RandPass.json')) {
  ...
  if (!fs.existsSync(process.cwd() + '/Sagor_Database')) {
    fs.mkdirSync(process.cwd() + '/Sagor_Database');
  }
  fs.writeFileSync(process.cwd() + '/Sagor_Database/RandPass.json', JSON.stringify(ArrPassWord, null, 2), 'utf8');
}

else {
  ArrPassWord = JSON.stringify(fs.readFileSync(process.cwd() + '/Sagor_Database/RandPass.json'));
}
